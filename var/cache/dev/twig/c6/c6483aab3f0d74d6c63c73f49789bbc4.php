...
class __TwigTemplate_24314bde05565319db7cd0c73648d91b extends Template
{
    private $source;
    private $macros = [];
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@Security/Collector/security.html.twig", "/var/guestbook/guestbook/vendor/symfony/security-bundle/Resources/views/Collector/security.html.twig");
    }
}
