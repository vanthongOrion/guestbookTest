...
class __TwigTemplate_023db740c754071c739f1d95db186fe8 extends Template
{
    private $source;
    private $macros = [];
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@WebProfiler/Collector/exception.html.twig", "/var/guestbook/guestbook/vendor/symfony/web-profiler-bundle/Resources/views/Collector/exception.html.twig");
    }
}
