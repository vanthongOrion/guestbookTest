...
class __TwigTemplate_5a7f912d8103910f7c16a420161d3d88 extends Template
{
    private $source;
    private $macros = [];
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@WebProfiler/Collector/config.html.twig", "/var/guestbook/guestbook/vendor/symfony/web-profiler-bundle/Resources/views/Collector/config.html.twig");
    }
}
