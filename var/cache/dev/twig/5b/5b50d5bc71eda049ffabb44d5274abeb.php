...
class __TwigTemplate_83f809c0ce9a8da3c333714fafe13eea extends Template
{
    private $source;
    private $macros = [];
...
Symfony Twig Bridge to ensure that all applications building backends with EasyAdmin
use the same version of the templates, even those still using Symfony 4.4.
", "@EasyAdmin/symfony-form-themes/README.txt", "/var/guestbook/guestbook/vendor/easycorp/easyadmin-bundle/src/Resources/views/symfony-form-themes/README.txt");
    }
}
