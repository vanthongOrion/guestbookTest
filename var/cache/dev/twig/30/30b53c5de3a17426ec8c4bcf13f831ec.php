...
class __TwigTemplate_0b2ba472c74f47481ba41874a7b042cf extends Template
{
    private $source;
    private $macros = [];
...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@WebProfiler/Collector/notifier.html.twig", "/var/guestbook/guestbook/vendor/symfony/web-profiler-bundle/Resources/views/Collector/notifier.html.twig");
    }
}
