...
class __TwigTemplate_fcd334027b6208c528065fe051978820 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"metrics\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["transport"]) {
            ...
            echo "</span>
                <span class=\"label\">";
            // line 97
            echo (((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["events"]) || array_key_exists("events", $context) ? $context["events"] : (function () { throw new RuntimeError('Variable "events" does not exist.', 97, $this->source); })()), "messages", [$context["transport"]], "method", false, false, false, 97)) == 1)) ? ("message") : ("messages"));
            echo "</span>
            </div>
        ";
        }
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["event"]) {
                ...
                if ( !twig_get_attribute($this->env, $this->source, ($context["message"] ?? null), "headers", [], "any", true, true, false, 113)) {
                    ...
                    echo "                                    <div class=\"card-block\">
                                        ...
                                        <h2 class=\"m-t-10\">";
                    // line 122
                    (((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["message"] ?? null), "headers", [], "any", false, true, false, 122), "get", ["subject"], "method", false, true, false, 122), "bodyAsString", [], "method", true, true, false, 122) &&  !(null === twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["message"] ?? null), "headers", [], "any", false, true, false, 122), "get", ["subject"], "method", false, true, false, 122), "bodyAsString", [], "method", false, false, false, 122)))) ? (print (twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["message"] ?? null), "headers", [], "any", false, true, false, 122), "get", ["subject"], "method", false, true, false, 122), "bodyAsString", [], "method", false, false, false, 122), "html", null, true))) : (print ("(empty)")));
                    echo "</h2>
                                    </div>
                                    ...
                                    <div class=\"card-block\">
                                        <div class=\"row\">
                                            <div class=\"col col-4\">
                                                ...
                                                <pre class=\"prewrap\">";
                    // line 129
                    echo twig_escape_filter($this->env, twig_replace_filter((((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["message"] ?? null), "headers", [], "any", false, true, false, 129), "get", ["from"], "method", false, true, false, 129), "bodyAsString", [], "method", true, true, false, 129) &&  !(null === twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["message"] ?? null), "headers", [], "any", false, true, false, 129), "get", ["from"], "method", false, true, false, 129), "bodyAsString", [], "method", false, false, false, 129)))) ? (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["message"] ?? null), "headers", [], "any", false, true, false, 129), "get", ["from"], "method", false, true, false, 129), "bodyAsString", [], "method", false, false, false, 129)) : ("(empty)")), ["From:" => ""]), "html", null, true);
                    echo "</pre>

                                                <span class=\"label\">To</span>
                                                <pre class=\"prewrap\">";
                    // line 132
                    echo twig_escape_filter($this->env, twig_replace_filter((((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["message"] ?? null), "headers", [], "any", false, true, false, 132), "get", ["to"], "method", false, true, false, 132), "bodyAsString", [], "method", true, true, false, 132) &&  !(null === twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["message"] ?? null), "headers", [], "any", false, true, false, 132), "get", ["to"], "method", false, true, false, 132), "bodyAsString", [], "method", false, false, false, 132)))) ? (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["message"] ?? null), "headers", [], "any", false, true, false, 132), "get", ["to"], "method", false, true, false, 132), "bodyAsString", [], "method", false, false, false, 132)) : ("(empty)")), ["To:" => ""]), "html", null, true);
                    echo "</pre>
                                            </div>
                                            <div class=\"col\">
...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@WebProfiler/Collector/mailer.html.twig", "/var/guestbook/guestbook/vendor/symfony/web-profiler-bundle/Resources/views/Collector/mailer.html.twig");
    }
}
